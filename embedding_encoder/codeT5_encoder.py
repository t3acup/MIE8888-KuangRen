...
OUTPUT_PATH = "embeddings/cpp_CodeT5_embeddings.pkl"

# === SETUP MODEL ===
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
model_name = "Salesforce/codet5-base"  # or "Salesforce/codet5-small" for smaller model
...
def get_embedding(code):
    try:
        ...
        with torch.no_grad():
            ...
            # Mean pooling over tokens for a fixed-size vector representation
